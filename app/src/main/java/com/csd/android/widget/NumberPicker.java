...
public class NumberPicker extends LinearLayout {
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mSelectionDivider = getResources().getDrawable(R.mipmap.num_sbanner);
		...
		mMaxHeight = mSelectionDivider.getIntrinsicWidth();
		...
		mMaxWidth = mSelectionDivider.getIntrinsicWidth();
